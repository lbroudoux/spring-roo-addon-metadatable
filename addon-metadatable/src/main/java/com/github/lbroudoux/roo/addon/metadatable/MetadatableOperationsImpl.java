...
public class MetadatableOperationsImpl implements MetadatableOperations {
	...
	public void setup() {
      ...
      projectOperations.addRepository("", new Repository("Metadatable Roo add-on repository", "Metadatable Roo add-on repository", "http://raw.github.com/lbroudoux/spring-roo-addon-metadatable/master/repo"));
		...
		dependencies.add(new Dependency("com.github.lbroudoux.roo.addon", "com.github.lbroudoux.roo.addon.metadatable", "0.1.0.BUILD", DependencyType.JAR, DependencyScope.COMPILE));
