...
@Service
public class MetadatableCommands implements CommandMarker { // All command types must implement the CommandMarker interface
	
	/**
	 * Get a reference to the MetadatableOperations from the underlying OSGi container
	 */
	@Reference private MetadatableOperations operations;
	 ...
	 */
	@CliAvailabilityIndicator({ "metadatable setup", "metadatable add", "metadatable all" })
	 ...
	 * @param type 
	 */
	@CliCommand(value = "metadatable add", help = "Some helpful description")
	 ...
	 * 
	 */
	@CliCommand(value = "metadatable all", help = "Some helpful description")
	public void all() {
	 ...
	 * 
	 */
	@CliCommand(value = "metadatable setup", help = "Setup Metadatable addon")
	public void setup() {
		operations.setup();
	}
}